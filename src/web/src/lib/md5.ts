// MD5 implementation. Public-domain port (Joseph Myers, http://www.myersdaily.org/joseph/javascript/md5-text.html).
// Used only for Gravatar URLs — never use MD5 for security.
